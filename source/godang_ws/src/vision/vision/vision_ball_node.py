...
def computeBallPosRobotframe(list_of_ball):
    ...
    if list_of_ball != []:
        ...
        for i in range(len(list_of_ball)):
            distance_ball_ = distance_ball_from_center(list_of_ball[i][0][0], list_of_ball[i][0][2])
            distance_ball_from_center_.append(distance_ball_)
...
class VisionBallNode(Node):
    ...
    def timer_callback(self):
        ...
        if BallPosRobot != []:
            ...
            print("found ball with robot pos ", Robot_pos)
