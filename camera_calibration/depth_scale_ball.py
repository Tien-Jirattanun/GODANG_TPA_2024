...
class BallDetection:
    ...
    def test_function(self):
        ...
        while True:
            ...
            if not ret:
                break
            cv2.imshow("undistort_image", frame)
    ...
    def robot_to_world_coordinates(self, robot_coords):
        ...
        robot_coords_homogeneous = np.array([Z_x, -X, 1]) #[Z-x],[x],[1]
...
if __name__ == "__main__":
    ...
    if len(detections) == 0:
        ...
        for i in range(len(uv)):
            ...
            print(f"robot_to_world_coordinates {robot_to_world_coordinates}")
            # print(f"robot_to_world_coordinates  X_r = {robot_to_world_coordinates[0]:.2f} m, Y_r = {robot_to_world_coordinates[1]:.2f} m, theta = {robot_to_world_coordinates[2]:.2f}")
