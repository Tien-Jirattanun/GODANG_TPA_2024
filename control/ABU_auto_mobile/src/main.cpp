...
rcl_publisher_t publisher_but;
std_msgs__msg__String pos_data;
std_msgs__msg__Float32MultiArray vel_data;
...
void setup1()
{
  ...
  // create publisher
  RCCHECK(rclc_publisher_init_default(&publisher, &node, ROSIDL_GET_MSG_TYPE_SUPPORT(std_msgs, msg, String), "pos_data"));
